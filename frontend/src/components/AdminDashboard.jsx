...
function AdminDashboard() {
    ...
    const loadReports = async () => {
      ...
      try {
        ...
        const dashboardResponse = await axios.get(
          "http://localhost:8080/admin/reports/dashboard",
          config
        );
        ...
        const orderResponse = await axios.get(
          "http://localhost:8080/admin/reports/orders",
          config
        );
        ...
        const productResponse = await axios.get(
          "http://localhost:8080/admin/reports/products",
          config
        );
        ...
        const refundResponse = await axios.get(
          "http://localhost:8080/admin/reports/refunds",
          config
        );
        ...
        const commissionResponse = await axios.get(
          "http://localhost:8080/admin/reports/commissions",
          config
        );
        ...
        if (!cancelled) {
          ...
          const commissions =
            Array.isArray(commissionResponse.data)
              ? commissionResponse.data
              : [];
  ...
  const openProductReportDetail = async (
    ...
    try {
      ...
      if (filterType === "ALL_PRODUCTS") {
        ...
        setReportDetailData(vendorData);
  ...
  const openRefundReportDetail = async (
    ...
    try {
      ...
      else if (filterType === "RETURN_REQUESTED") {
      ...
      else if (filterType === "RETURN_APPROVED") {
      ...
      else if (filterType === "RETURN_REJECTED") {
  ...
  const openCommissionReportDetail = async (
    ...
    try {
      ...
      const commissions = Array.isArray(response.data)
        ? response.data
        : [];
      ...
      else if (filterType === "POSITIVE_COMMISSION") {
            ...
            {!loadingReportDetail &&
              ...
              reportDetailType === "products" && (
                ...
                <div className="report-detail-table-wrapper">
                  ...
                  {reportDetailTitle === "Products by Vendor" && (
            ...
            <div className="report-grid">
              ...
              >
                ...
                <strong>
                  {loadingStats
                    ? "..."
                    : `₹${commissionReport.totalOrderAmount.toFixed(2)}`}
                </strong>
              ...
              >
                ...
                <strong>
                  {loadingStats
                    ? "..."
                    : `₹${commissionReport.totalVendorAmount.toFixed(2)}`}
                </strong>
